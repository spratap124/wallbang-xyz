...
# Prefer NEXT_PUBLIC_SERVER_HOST_RETAKE_1; NEXT_PUBLIC_RETAKE_HOST is a legacy alias.
ARG NEXT_PUBLIC_SERVER_HOST_RETAKE_1
ARG NEXT_PUBLIC_RETAKE_HOST
ENV NEXT_PUBLIC_SITE_URL=$NEXT_PUBLIC_SITE_URL
ENV NEXT_PUBLIC_DISCORD_URL=$NEXT_PUBLIC_DISCORD_URL
ENV NEXT_PUBLIC_SERVER_HOST_RETAKE_1=$NEXT_PUBLIC_SERVER_HOST_RETAKE_1
