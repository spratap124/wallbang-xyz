  ...
  return [
    {
      ...
      months: 1,
      durationDays: 30,
      perServerPaise: parsePaise(process.env.VIP_SERVER_PRICE_1M_PAISE, 14_900),
      allServersPaise: parsePaise(process.env.VIP_PRICE_1M_PAISE, 24_900),
    },
    {
      id: "3_months",
      name: "3 Months",
      months: 3,
      durationDays: 90,
      perServerPaise: parsePaise(process.env.VIP_SERVER_PRICE_3M_PAISE, 39_900),
      allServersPaise: parsePaise(process.env.VIP_PRICE_3M_PAISE, 64_900),
    },
    {
      id: "6_months",
      name: "6 Months",
      months: 6,
      durationDays: 180,
      perServerPaise: parsePaise(process.env.VIP_SERVER_PRICE_6M_PAISE, 69_900),
      allServersPaise: parsePaise(process.env.VIP_PRICE_6M_PAISE, 109_900),
    },
    {
      id: "1_year",
      name: "1 Year",
      months: 12,
      durationDays: 365,
      perServerPaise: parsePaise(process.env.VIP_SERVER_PRICE_1Y_PAISE, 124_900),
      allServersPaise: parsePaise(process.env.VIP_PRICE_1Y_PAISE, 199_900),
    },
  ];
}
