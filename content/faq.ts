...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Buy prepaid VIP on the Pricing page. Select a server, then 1 / 3 / 6 months or 1 year — paid once at checkout with no auto-renewal. During the launch offer, a limited number of players can also claim free VIP after signing in with Steam. A paid term extends your current expiry if VIP is still active.",
  },
  {
    id: "regions",
