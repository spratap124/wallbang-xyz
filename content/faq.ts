...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "[WallBang] Retake #1 [HYD] is live now. Use the Connect button on the homepage (or the connect command) to open CS2 through Steam. More platform features — VIP, stats, and profiles — continue rolling out on the public roadmap.",
  },
  {
    id: "is-it-free",
